...
namespace mexx\elementapicachebuster;

use mexx\elementapicachebuster\services\ElementApiCacheBusterService as ElementApiCacheBusterServiceService;
 ...
 * @since     0.0.1
 *
 * @property  ElementApiCacheBusterServiceService $elementApiCacheBusterService
 */
class ElementApiCacheBuster extends Plugin
{
    // Static Properties
    // =========================================================================
     ...
     * ElementApiCacheBuster::$plugin
     *
     * @var ElementApiCacheBuster
     */
